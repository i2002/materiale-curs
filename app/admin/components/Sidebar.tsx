...
export default function Sidebar() {
  ...
  return (
    <div className="bg-white w-60 h-screen">
      <div className="h-16 flex items-center px-5 bg-teal-300 border-r border-r-teal-400">
        <Title>Admin</Title>
      </div>
      <nav className="p-3 flex flex-col border-r border-teal-200 items-stretch">
